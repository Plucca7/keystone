...
| G2  | Honest scope                                 | M3/M4 (plan→tasks, verify) are NOT claimed as delivered. M1 (constitution) and M2 (clarify) ARE. Check `git log` and the working tree. If a later milestone is claimed but absent -> REFUTED |
